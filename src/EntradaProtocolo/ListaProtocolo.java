 ...
 * @author edson
 */
public class ListaProtocolo extends javax.swing.JFrame {

    //chama telas
    AddProtocolo add = new AddProtocolo();
    EditProtocolo edit = new EditProtocolo();
    // chama benas e dao
    ...
    private void jTable_ListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_ListaMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (jCheckBoxMenuItem3.isSelected()) {
                ...
                if (op == 0) {
                    BP.setId_protocolo((codigo));
                    DP.LimpaValidar(BP);
                    edit.BloqueiaCampos1();
                    edit.PreencherFornecedor();
                    edit.RecebeId(codigo);
                    edit.VerificaLimpaValidar();
//                    edit.BloqueiaCampos1();
                    edit.Chama();
                    edit.PreencherTotal();
                    edit.PreencheTabela();
        ...
        if (evt.getClickCount() == 1) {
            ...
            try {
                id_linha = (int) jTable_Lista.getValueAt(jTable_Lista.getSelectedRow(), 8);
                codigo = (int) jTable_Lista.getValueAt(jTable_Lista.getSelectedRow(), 0);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaProtocolo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaProtocolo().setVisible(true);
            }
        });
    }
    ...
    public void PreencheTabela() {
        ...
        String[] colunas = new String[]{"Código ", "Status",  "Data", "Fornecedor", "Protocolo", "Observação", "Registro"};
        conex.conexao();
            conex.executaSql2("SELECT *  FROM tbl_protocolo \n"
                    + "inner join tbl_usuario on id_usuario =protocolo_id_usuario \n"
                    + "inner join tbl_fornecedor on fornecedor_id =protocolo_id_fornecedor \n"
                                                            + " where (coalesce((protocolo_numero)) "
                    + "||' '||coalesce((protocolo_data))||' '|| coalesce((fornecedor_nome))"
                                        + "||' '||coalesce((protocolo_observacao))  )ilike '%" + resposta + "%'  \n"
        ...
        try {
            ...
            do {
                ...
                String status = conex.rs.getString("protocolo_status");
                ...
                String MenuMinhaData = conex.rs.getString("protocolo_registro");
                String MenuMeuUsuario = conex.rs.getString("nome_usuario");
                String MinhaObs = conex.rs.getString("protocolo_observacao");
                dados.add(new Object[]{conex.rs.getInt("id_protocolo"), status,
                      conex.rs.getString("protocolo_data"), conex.rs.getString("fornecedor_nome"),
                    conex.rs.getString("protocolo_numero"), MinhaObs,
