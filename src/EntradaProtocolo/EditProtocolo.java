 ...
 * @author edson
 */
public class EditProtocolo extends javax.swing.JFrame {
...
//        jTable2.setModel(modelo);
    ...
    public void PreencherTotal() {
        ...
        conex.executaSql2(" SELECT SUM ((produto_valor * t_qtd)) AS total FROM public.tbl_item_temp \n"
                + "                inner join public.tbl_produto on produto_id  =t_produto_id \n"
                + "               where item_id_protocolo=" + UltimoIdNota + " and t_item_st !=3 and t_item_st !=2\n"
                + "                GROUP BY tbl_item_temp.item_id_protocolo");
        try {
            conex.rs.first();
...
//        BP.setNota_id_cfop(Integer.parseInt((String) jComboBox2.getSelectedItem()));
        ...
        BP.setprotocolo_numero(jT_numero.getText());
...
//        BP.setNota_total(Double.parseDouble(total));
    ...
    public void PreencherFornecedor() {
        ...
        try {
            conex.rs.first();
            jC_fornecedor.removeAllItems();
            jComboBox4.removeAllItems();

            do {
                jC_fornecedor.addItem(conex.rs.getString("fornecedor_nome"));
...
//        jComboBox2.setEnabled(false);
        jC_fornecedor.setEnabled(false);
...
//        jButton3.setEnabled(false);
    ...
    private void initComponents() {
        ...
        jC_fornecedor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jC_fornecedor.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jC_fornecedorItemStateChanged(evt);
            }
        });
        jC_fornecedor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jC_fornecedorKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(jC_fornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jT_numero, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            String MenuMinhaHoraSistema = (String.format("%1$tM:%1$tS", Relogio)); /// %1$tM:%1$tS
    ...
    private void jC_fornecedorItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jC_fornecedorItemStateChanged
        try {
            jComboBox4.setSelectedIndex(jC_fornecedor.getSelectedIndex());
        } catch (Exception e) {
        }

    }//GEN-LAST:event_jC_fornecedorItemStateChanged
...
//        jComboBox1.requestFocus();
    ...
    private void jC_fornecedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jC_fornecedorKeyPressed
        if (evt.getKeyCode() == evt.VK_F5) {
            PreencherFornecedor();
        }
    }//GEN-LAST:event_jC_fornecedorKeyPressed
    ...
    private void jT_numeroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jT_numeroKeyReleased
        String s = jT_numero.getText();
        String formatado = "";
        if (evt.getKeyCode() == evt.VK_DELETE | evt.getKeyCode() == evt.VK_BACK_SPACE | evt.getKeyCode() == evt.VK_SPACE | evt.getKeyCode() == evt.VK_RIGHT | evt.getKeyCode() == evt.VK_LEFT) {
            ...
            if (s.matches("^[0-9]*$")) {
                if (s.length() < 9) {
                    ...
                    jT_numero.setText(formatado);
                }
            } else {
                jT_numero.setText("");
            }
        }
    }//GEN-LAST:event_jT_numeroKeyReleased
...
//        rid = id;s
    ...
    public void Chama() {
        ...
        conex.conexao();
        conex.executaSql2(" SELECT *"
                + "  FROM public.tbl_protocolo where id_protocolo=" + UltimoIdNota + "  \n"
                + "  order by id_protocolo  asc");
        try {
            conex.rs.last();
            UltimoIdNota = conex.rs.getString("id_protocolo");
            jC_fornecedor.setSelectedItem(conex.rs.getString("protocolo_id_fornecedor"));
            jTextField_Hora.setText(conex.rs.getString("protocolo_hora"));
            jT_numero.setText(conex.rs.getString("protocolo_numero"));
            jLabel_observacao.setText(conex.rs.getString("protocolo_observacao"));
            this.setTitle("Editar protocolo " + " ( Código " + UltimoIdNota + " )");
            System.out.println("protocolo.EditNota.Chama() " + conex.rs.getString("protocolo_data"));

            try {
                data = formato.parse(conex.rs.getString("protocolo_data"));
                jDateChooser_Data_Nota.setDate(data);

            } catch (Exception e) {
            }

            System.out.println("chama foicarregado");
        } catch (SQLException ex) {
            System.out.println("erro ao  careegar chama  " + ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditProtocolo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditProtocolo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox<String> jC_fornecedor;
