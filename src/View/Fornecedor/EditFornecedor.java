 ...
 * @author edson
 */
public class EditFornecedor extends javax.swing.JDialog {
// Chama conexao
...
// Campos internos
     ...
     */
    public EditFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public String AjustaCampoGenerico(String a, int b) {
        ...
        BEANS.setTexto(a);
        String texto = null;
        for (BeansFornecedor c : control.AjustaCampoGenerico(BEANS)) {
...
//        VerificaMeuCep();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditFornecedor dialog = new EditFornecedor(new javax.swing.JFrame(), true);
    ...
    public void Editar() {
        ...
        BEANS.setFornecedor_id(id_referencia);
        BEANS.setFornecedor_nome(jTextFieldNome.getText());
        BEANS.setFornecedor_cnpj(jFormattedTextFieldCnpj.getText());
        BEANS.setFornecedor_inscricao(jFormattedTextFieldInscricao.getText());
        BEANS.setFornecedor_descricao(jTextFieldDescricao.getText());
        BEANS.setFornecedor_telefone(jFormattedTextFieldTelefone.getText());
        BEANS.setFornecedor_endereco(jTextFieldEndereco.getText());
        BEANS.setFornecedor_no(jTextFieldNumero.getText());
        BEANS.setFornecedor_cep(jFormattedTextFieldCep.getText());
        BEANS.setFornecedor_complemento(jTextFieldComplemento.getText());
        BEANS.setFornecedor_bairro(jTextFieldBairro.getText());
        BEANS.setFornecedor_cidade(jTextFieldCidade.getText());
        BEANS.setFornecedor_observacao(jTextArea_Observacao.getText());
        BEANS.setFornecedor_nome(jTextFieldNome.getText());
        BEANS.setFornecedor_status(1);
        BEANS.setFornecedor_usuario_id(Integer.parseInt(Menu.jLabelIdUsuario.getText()));

        DAO.Editar(BEANS);
        LimpaCampos();
        ListaFornecedor.jMenuItem4.doClick();
    ...
    public void ChamaUltimo() {
        conex.conexao();
        conex.executaSql2("SELECT  id_unidade  FROM tbl_unidade where id_unidade is not null and id_unidade !=0 order by id_unidade asc ");
        try {
            conex.rs.last();
            id_referencia = conex.rs.getInt("id_unidade");
            id_referencia = id_referencia + 1;
        } catch (SQLException ex) {
            id_referencia = 1;
        }
        conex.desconecta();
        System.out.println("Usuario.AddUsuario.ChamaUltimo() -- " + id_referencia);
    ...
    public void Chama() {
        conex.conexao();
        conex.executaSql2("SELECT  *  FROM tbl_fornecedor where fornecedor_id ='" + Rid + "' order by fornecedor_id asc ");
        try {
            conex.rs.last();
            id_referencia = (conex.rs.getInt("fornecedor_id"));
            System.out.println(" -id_referencia-- " + id_referencia);
            System.err.println("  -Rid-- " + Rid);

            jTextFieldNome.setText(conex.rs.getString("fornecedor_nome"));
            jFormattedTextFieldCnpj.setText(conex.rs.getString("fornecedor_cnpj"));
            jFormattedTextFieldInscricao.setText(conex.rs.getString("fornecedor_inscricao"));
            jTextFieldDescricao.setText(conex.rs.getString("fornecedor_descricao"));
            jFormattedTextFieldTelefone.setText(conex.rs.getString("fornecedor_telefone"));
            jTextFieldEndereco.setText(conex.rs.getString("fornecedor_endereco"));
            jTextFieldNumero.setText(conex.rs.getString("fornecedor_no"));
            jFormattedTextFieldCep.setText(conex.rs.getString("fornecedor_cep"));
            jTextFieldComplemento.setText(conex.rs.getString("fornecedor_complemento"));
            jTextFieldBairro.setText(conex.rs.getString("fornecedor_bairro"));
            jTextFieldCidade.setText(conex.rs.getString("fornecedor_cidade"));
            jTextArea_Observacao.setText(conex.rs.getString("fornecedor_observacao"));
            jTextFieldNome.setText(conex.rs.getString("fornecedor_nome"));
