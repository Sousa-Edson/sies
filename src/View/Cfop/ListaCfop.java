 ...
 * @author edson
 */
public class ListaCfop extends javax.swing.JFrame {

    //chama telas
    AddCfop add = new AddCfop(this, rootPaneCheckingEnabled);
    EditCfop edit = new EditCfop(this, rootPaneCheckingEnabled);
    // chama benas e dao
...
//        jMenuItem4.setVisible(false);
    ...
    private void initComponents() {
        ...
        jTable_Lista_inativos.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jTable_Lista_inativosMouseEntered(evt);
            }
        });
...
//       JOptionPane.showMessageDialog(rootPane, "sair");
    ...
    private void jTable_Lista_inativosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_Lista_inativosMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_jTable_Lista_inativosMouseEntered
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaCfop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void PreencheTabela() {
        ...
        String[] colunas = new String[]{"Id", "Status", "Cfop", "Descrição", "Registro"};
        ArrayList dados;
        String b = resposta;
        ...
        jTable_Lista.getColumnModel().getColumn(3).setPreferredWidth(235);
    ...
    public void PreencheTabela_Inativos() {
        String[] colunas = new String[]{"Id inativo", "Status", "Cfop", "Descrição", "Registro"};
        ArrayList dados;
        String b = resposta;
        ...
        jTable_Lista_inativos.getColumnModel().getColumn(3).setPreferredWidth(235);
        jTable_Lista_inativos.getColumnModel().getColumn(3).setResizable(true);
        jTable_Lista_inativos.getColumnModel().getColumn(4).setPreferredWidth(140);
    ...
    public void UpdateStatus() {
        ...
        BEANS.setId_cfop(codigo);
        if (Status.equals("Ativo")) {
            BEANS.setStatus_cfop(0);
        } else if (Status.equals("Inativo")) {
            BEANS.setStatus_cfop(1);
        } else {
            BEANS.setStatus_cfop(1);
        }
        System.out.println("codigo up -> " + codigo + "Status " + Status);
    ...
    public void ExcluirItem() {
        ...
        System.out.println("PedidoExcluir =" + PedidoExcluir);
        if (PedidoExcluir == null) {
            PedidoExcluir = "";
            System.out.println("excluir 0");
        } else {
