...
public class ListaProduto extends javax.swing.JFrame {
    ...
    int codigo;
    JDialog_Opcao op = new JDialog_Opcao(this, rootPaneCheckingEnabled);
...
//        jMenuItem4.setVisible(false);
    ...
    private void initComponents() {
        ...
        jCheckBox_editar.setSelected(true);
    ...
    private void jTable_ListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_ListaMouseClicked
        ...
        if (evt.getButton() == MouseEvent.BUTTON3) {
            ...
            if (evt.getClickCount() == 2) {
                ...
                String descricao = "" + jTable_Lista.getValueAt(jTable_Lista.getSelectedRow(), 3);
...
//      JOptionPane.showMessageDialog(rootPane, "sair");
        ...
        if (evt.getButton() == MouseEvent.BUTTON3) {
            ...
            if (evt.getClickCount() == 2) {
                ...
                if (evt.getClickCount() == 2) {
                    ...
                    System.out.println(" edit = " + edit + " delete = " + delete);
                    String cod = "" + jTable_Lista_inativos.getValueAt(jTable_Lista_inativos.getSelectedRow(), 0);
                    String descricao = "" + jTable_Lista_inativos.getValueAt(jTable_Lista_inativos.getSelectedRow(), 3);
                    String st = "" + jTable_Lista_inativos.getValueAt(jTable_Lista_inativos.getSelectedRow(), 1);
                    this.op.RecebeDados(descricao, cod, edit, delete, st);
                    this.op.setVisible(true);
                }
                if (evt.getClickCount() == 1) {
    ...
    public void PreencheTabela() {
        ...
        String[] colunas = new String[]{"Codigo ", "Status", "Categoria", "Produto", "Un", "Valor R$", "Descrição", "Registro"};
        ArrayList dados;
        String b = resposta;
        ...
        jTable_Lista.getColumnModel().getColumn(2).setPreferredWidth(80);
        ...
        jTable_Lista.getColumnModel().getColumn(4).setPreferredWidth(40);
...
//  jTable_Lista.getColumnModel().getColumn(5).isCellVisible(false);
    ...
    public void PreencheTabela_Inativos() {
        String[] colunas = new String[]{"Codigo inativo", "Status", "Categoria", "Produto", "Un", "Valor R$", "Descrição", "Registro"};
        ArrayList dados;
        String b = resposta;
        ...
        jTable_Lista_inativos.getColumnModel().getColumn(2).setPreferredWidth(80);
        ...
        jTable_Lista_inativos.getColumnModel().getColumn(4).setPreferredWidth(40);
        jTable_Lista_inativos.getColumnModel().getColumn(4).setResizable(true);
        jTable_Lista_inativos.getColumnModel().getColumn(5).setPreferredWidth(80);
        ...
        jTable_Lista_inativos.getColumnModel().getColumn(7).setPreferredWidth(180);
        jTable_Lista_inativos.getColumnModel().getColumn(7).setResizable(true);
