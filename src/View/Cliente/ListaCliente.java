...
public class ListaCliente extends javax.swing.JFrame {
     ...
     *
     */
//    public boolean rootPaneCheckingEnabled = false;
    //chama telas
    AddCliente add = new AddCliente(this, rootPaneCheckingEnabled);
    EditCliente edit = new EditCliente(this, rootPaneCheckingEnabled);
    // chama benas e dao
    ...
    // uso interno
    String resposta = "", resposta_inativo = "", Status;
    int codigo;
...
//     JOptionPane.showMessageDialog(rootPane, "sair");
    ...
    public void PreencheTabela_Inativos() {
        String[] colunas = new String[]{"Codigo excluido", "Status", "Nome", "Descrição", "telefone", "Observação", "Registro"};
        ArrayList dados;
        String b = resposta;
    ...
    public void UpdateStatus() {
        ...
        BEANS.setCliente_id(codigo);
        if (Status.equals("Ativo")) {
            BEANS.setCliente_status(0);
