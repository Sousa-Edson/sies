...
// Campos internos
     ...
     */
    public AddEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ChamaUltimo();
        Chama();
 ...
 public void AjustaMeuDescricao() {
    ...
    public String AjustaCampoGenerico(String a, int b) {
        ...
        BEANS.setTexto(a);
        String texto = null;
        for (BeansEmpresa c : control.AjustaCampoGenerico(BEANS)) {
    ...
    private void initComponents() {
        ...
        setTitle("Adicionar e/ou editar empresa");
        setResizable(false);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(jTextFieldDescricao, javax.swing.GroupLayout.DEFAULT_SIZE, 472, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jFormattedTextFieldCnpj, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextFieldComplemento, javax.swing.GroupLayout.DEFAULT_SIZE, 450, Short.MAX_VALUE)))))
                .addGap(26, 26, 26))
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabelExibirInformacoes, javax.swing.GroupLayout.PREFERRED_SIZE, 443, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(54, 54, 54))
...
//            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddEmpresa dialog = new AddEmpresa(new javax.swing.JFrame(), true);
...
//    }
    ...
    public void ChamaUltimo() {
        conex.conexao();
        conex.executaSql2("SELECT  empresa_id  FROM tbl_empresa where empresa_id is not null and empresa_id !=0 order by empresa_id asc ");
        try {
            conex.rs.last();
            id_referencia = conex.rs.getInt("empresa_id");
//            id_unico = conex.rs.getInt("empresa_id_unico");
            ...
            id_referencia = 1;
            modo = 0;
            jButton_Salvar.setText("Incluir empresa ");
        }
        conex.desconecta();
        System.err.println(" ChamaUltimo() -- " + id_referencia);
    ...
    public void evento_Verifica() {
        if (jTextFieldNome.getText().trim().isEmpty()) {
            ...
            if (modo == 1) {
                System.out.println("evento_Verifica - editar");
                Controle();
                Editar();

            } else {
                System.out.println("evento_Verifica - salvar");
                Controle();
                Salvar();
    ...
    public void Salvar() {
        ...
        DAO.Salvar(BEANS);
        LimpaCampos();
        //ListaEmpresa.jMenuItem4.doClick();
        JOptionPane.showMessageDialog(null, "Cadastrado com sucesso. ");
        this.dispose();
    }

    public void Editar() {
        BEANS.setEmpresa_id(id_referencia);
        DAO.Editar(BEANS);
    ...
    public void Controle() {
        BEANS.setEmpresa_id(id_referencia);
        BEANS.setEmpresa_nome(jTextFieldNome.getText());
        BEANS.setEmpresa_cnpj(jFormattedTextFieldCnpj.getText());
        BEANS.setEmpresa_inscricao(jFormattedTextFieldInscricao.getText());
        BEANS.setEmpresa_descricao(jTextFieldDescricao.getText());
        BEANS.setEmpresa_telefone(jFormattedTextFieldTelefone.getText());
        BEANS.setEmpresa_endereco(jTextFieldEndereco.getText());
        BEANS.setEmpresa_no(jTextFieldNumero.getText());
        BEANS.setEmpresa_cep(jFormattedTextFieldCep.getText());
        BEANS.setEmpresa_complemento(jTextFieldComplemento.getText());
        BEANS.setEmpresa_bairro(jTextFieldBairro.getText());
        BEANS.setEmpresa_cidade(jTextFieldCidade.getText());
        BEANS.setEmpresa_observacao(jTextArea_Observacao.getText());

        BEANS.setEmpresa_status(1);
        BEANS.setEmpresa_usuario_id(Integer.parseInt(Menu.jLabelIdUsuario.getText()));
    }

    /// manipula edição
    public void Chama() {
        conex.conexao();
        conex.executaSql2("SELECT  *  FROM tbl_empresa where empresa_id ='" + id_referencia + "' order by empresa_id asc ");
        try {
            conex.rs.last();
            id_referencia = (conex.rs.getInt("empresa_id"));
            System.out.println(" -id_referencia-- " + id_referencia);

            jTextFieldNome.setText(conex.rs.getString("empresa_nome"));
            jFormattedTextFieldCnpj.setText(conex.rs.getString("empresa_cnpj"));
            jFormattedTextFieldInscricao.setText(conex.rs.getString("empresa_inscricao"));
            jTextFieldDescricao.setText(conex.rs.getString("empresa_descricao"));
            jFormattedTextFieldTelefone.setText(conex.rs.getString("empresa_telefone"));
            jTextFieldEndereco.setText(conex.rs.getString("empresa_endereco"));
            jTextFieldNumero.setText(conex.rs.getString("empresa_no"));
            jFormattedTextFieldCep.setText(conex.rs.getString("empresa_cep"));
            jTextFieldComplemento.setText(conex.rs.getString("empresa_complemento"));
            jTextFieldBairro.setText(conex.rs.getString("empresa_bairro"));
            jTextFieldCidade.setText(conex.rs.getString("empresa_cidade"));
            jTextArea_Observacao.setText(conex.rs.getString("empresa_observacao"));
            jTextFieldNome.setText(conex.rs.getString("empresa_nome"));
