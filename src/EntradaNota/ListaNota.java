 ...
 * @author edson
 */
public class ListaNota extends javax.swing.JFrame {
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaNota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaNota().setVisible(true);
            }
        });
    }

    public void PreencheTabela() {
        String[] colunas = new String[]{"Código ", "Status", "Cfop", "Data", "Fornecedor", "Nfe", "Observação", "Registro"};
        ArrayList dados;
        String b = resposta;
