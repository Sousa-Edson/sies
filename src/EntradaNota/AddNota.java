...
public class AddNota extends javax.swing.JFrame {
    ...
    String resposta = "", observacao = "", MinhaData, UltimoIdNota = "", item_id_nota;
    ...
    public void Chama() {
        ModoDeSalvar = 1;
        item_id_campo = "item_id_nota";
        for (BeansNota n : DAO.Chama(UltimoIdNota)) {
            UltimoIdNota = String.valueOf(n.getId_nota());
            jTextField_Hora.setText(n.getNota_hora());
            jTextField2.setText(n.getNota_numero());
            jTextField3.setText(n.getNota_chave());
            jLabel_observacao.setText(n.getNota_observacao());
            this.setTitle("Editar Nf-e " + " ( Código " + UltimoIdNota + " )");
            try {
                data = formato.parse(n.getNota_data());
                jDateChooser_Data_Nota.setDate(data);
            } catch (Exception e) {
            }
            int icf = n.getNota_id_cfop();
            PreencherNatureza2(icf);
            int ifo = n.getNota_id_fornecedor();
            PreencherFornecedor2(ifo);
        }
    ...
    public void PreencheTabela() {
        ...
        String b = item_id_nota;
        System.out.println("addnota -------------- b - " + b + " item_id_campo - " + item_id_campo);
        ArrayList dados;
        String[] colunas = new String[]{"Codigo ", "Produto", "UN", "Valor Un", "Quantidade", "Sub total"};
        DaoItem DaoI = new DaoItem();
        dados = (ArrayList) DaoI.PreencheTabela(b, item_id_campo);
        ModeloTabela modelo = new ModeloTabela(dados, colunas);
        jTable1.setModel(modelo);
    ...
    public void PreencherNatureza() {
        ...
        resposta = "";
        DaoCfop CFOP = new DaoCfop();
        for (BeansCfop u : CFOP.PreencheCfop()) {
            jComboBox1.addItem(u.getSigla_cfop() + " | " + u.getDescricao_cfop());
            jComboBox2.addItem(String.valueOf(u.getId_cfop()));
        }
    }

    public void PreencherNatureza2(int A) {
        int a = A;
        jComboBox1.removeAllItems();
        jComboBox2.removeAllItems();
        resposta = "";
        DaoCfop CFOP = new DaoCfop();
        for (BeansCfop u : CFOP.PreencheCfop2(a)) {
            jComboBox1.addItem(u.getSigla_cfop() + " | " + u.getDescricao_cfop());
            jComboBox2.addItem(String.valueOf(u.getId_cfop()));
        }
    }
    ...
    public void PreencherFornecedor() {
        ...
        for (BeansFornecedor u : FORN.PreencheFornecedor()) {
            jComboBox3.addItem(u.getFornecedor_nome());
            jComboBox4.addItem(String.valueOf(u.getFornecedor_id()));
        }
    }

    public void PreencherFornecedor2(int A) {
        int a = A;
        jComboBox3.removeAllItems();
        jComboBox4.removeAllItems();
        resposta = "";
        DaoFornecedor FORN = new DaoFornecedor();
        for (BeansFornecedor u : FORN.PreencheFornecedor2(a)) {
            jComboBox3.addItem(u.getFornecedor_nome());
            jComboBox4.addItem(String.valueOf(u.getFornecedor_id()));
        }
    }
    ...
    private void initComponents() {
        ...
        jM_Atualizar = new javax.swing.JMenuItem();
        ...
        jM_Atualizar.setText("Prencher tabela");
        jM_Atualizar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jM_AtualizarActionPerformed(evt);
            }
        });
        jMenu1.add(jM_Atualizar);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Processar();
        PreencherTotal();
//        this.setTitle(" " + " ( Código " + UltimoIdNota + " )");
...
//        jComboBox2.setSelectedIndex(jComboBox1.getSelectedIndex());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        AddItem.RecebeItemIdNota(UltimoIdNota, item_id_campo);
        AddItem.PreencheTabela();
        AddItem.setVisible(true);
        PreencheTabela();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jM_AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jM_AtualizarActionPerformed
        PreencheTabela();
        System.err.println("pressionado");
    }//GEN-LAST:event_jM_AtualizarActionPerformed
...
//        j.ItemObs(jLabel_observacao.getText());
        PreencheTabela();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        Chama();        // TODO add your handling code here:
    ...
    public static javax.swing.JMenuItem jM_Atualizar;
