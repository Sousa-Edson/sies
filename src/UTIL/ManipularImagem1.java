...
public class ManipularImagem1 {
    ...
    public static BufferedImage setImagemDimensao(String caminhoImg, Integer imgLargura, Integer imgAltura) {
        ...
        try {
            ...
            Logger.getLogger(ManipularImagem1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void exibiImagemLabel(byte[] minhaimagem, javax.swing.JLabel label)
{
    ...
    public static void exibiImagemLabel_scale(byte[] minhaimagem, javax.swing.JLabel label)
{
        //primeiro verifica se tem a imagem
        //se tem convert para inputstream que é o formato reconhecido pelo ImageIO
        ...
        if(minhaimagem!=null)
        {
            ...
            try {
                BufferedImage imagem = ImageIO.read(input);
                Image imagemMenor = imagem.getScaledInstance(180, 180, 0);
                label.setIcon(new ImageIcon(imagemMenor));
